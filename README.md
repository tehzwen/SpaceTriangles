To successfully compile the project you will need to download threejs from https://threejs.org/, click the download link on the left and put the folder into the threejsgame folder under the name
of "three.js-master".
